...
TRANSIENT_CUT_TIME = None  # e.g. 150000, or None
...
def plot_heatmap(piv: pd.DataFrame, title: str, xlabel: str, ylabel: str, outpath: Path,
    ...
    # NOTE: label derived from metric is set by the caller in the title.
    # Keep this blank to avoid NameError and keep plots clean.
