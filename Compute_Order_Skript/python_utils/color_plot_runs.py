...
# CSV-Datei, Output
CSV_FILE = "analyse/compute_order.csv"
PNG_FILE = "analyse/compute_order.png"
...
# ---------- Plotfunktion ----------
def plot(csv_file,png_file,xcol,ycol,wcol,xlabel,ylabel,wlabel,xsize,ysize,title,scatter,cmap,log,valid_cols):
...
def main():
    ...
    ap.add_argument("--csv", default=CSV_FILE, help="Optional: csv-file")
    ap.add_argument("--output", default=PNG_FILE, help="Optional: png-file")
    ...
    ap.add_argument("--title", default=TITLE, help="Optional: Title")
    ...
    ap.add_argument("--valid_cols",default=None, help="Optional: Valid Cols (comma separated)")
    ...
    Plot_Err=0
    out = plot(csv_file,png_file,xcol,ycol,wcol,xlabel,ylabel,wlabel,xsize,ysize,title,scatter,cmap,log,valid_cols)
    if out:
        print(f"Saved: {os.path.basename(out)}")
    else:
        print(f"Error: {png_file}", file=sys.stderr)
        Plot_Err=1
