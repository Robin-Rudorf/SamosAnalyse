...
parser=argparse.ArgumentParser(description="Create csv-file from pickle-files (CSV-Format: cc,rand,tau,v,k,nu,gamma,permult,line,AlphaRelaxationTime,IsGlassy,DataCount,minSelfInt)",
...
with open(dir_pickle+"pickle.csv") as f:
    ...
    for row in csv_data:
        ...
        csv_zeile=csv_zeile+str(min(SelfInt))
...
print("CSV-Format: cc,rand,tau,v,k,nu,gamma,permult,line,AlphaRelaxationTime,IsGlassy,DataCount,minSelfInt")
