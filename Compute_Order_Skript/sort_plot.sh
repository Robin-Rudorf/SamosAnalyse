...
do
  ...
  python3 ../python_utils/plot_runs.py --csv ${filename} --output "${output_prefix}Ovar.png" --title "${Dir_Name} ${sort_name}" --x ${xwert} --y O_var --group ${group} --xsize ${x_size} --cmap ${colormap} --ms ${markersize}|| plot_err=1
  python3 ../python_utils/plot_runs.py --csv ${filename} --output "${output_prefix}Omean.png" --title "${Dir_Name} ${sort_name}" --x ${xwert} --y O_mean --group ${group} --xsize ${x_size} --cmap ${colormap} --ms ${markersize}|| plot_err=1
done
